...
import { getPeopleIFollow, unfollowPerson } from "../services/contactService";
...
const Following: React.FC = () => {
  ...
  const fetchFollowing = async () => {
    ...
    try {
      const data = await getPeopleIFollow(memberID);
  ...
  const handleUnfollow = async (contactID: string) => {
    if (!memberID) return;
        ...
        {following.map((res, index) => (
          ...
          >
            ...
            <Button
              ...
              onClick={() => handleUnfollow(res.contact_id)}
            >
              <b>Unfollow</b>
            </Button>
          </div>
