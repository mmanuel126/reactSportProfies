...
type SettingPopoverMenuProps = {
  selected: string;
  onSelect: (value: string) => void;
};

const SettingPopoverMenu: React.FC<SettingPopoverMenuProps> = ({
  selected,
  onSelect,
}) => {
  const options = ["Account Settings", "Privacy Settings"];
  ...
  const popover = (
    ...
    >
      ...
      >
        <i className="fa-solid fa-gear"></i>&nbsp;<b>Settings</b>
      </div>
...
export default SettingPopoverMenu;
