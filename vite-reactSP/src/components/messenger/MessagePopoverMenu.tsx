...
type MessagePopoverMenuProps = {
  selected: string;
  onSelect: (value: string) => void;
};

const MessagePopoverMenu: React.FC<MessagePopoverMenuProps> = ({
  selected,
  onSelect,
}) => {
  const options = ["All Messages", "Un-read Messages"];
  ...
  const popover = (
    ...
    >
      ...
      >
        <i className="fab fa-facebook-messenger"></i>&nbsp;&nbsp;<b>Messages</b>
      </div>
...
export default MessagePopoverMenu;
