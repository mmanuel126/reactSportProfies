...
export async function getRecentNews(): Promise<NewsItem[]> {
  return await apiFetch<NewsItem[]>("/api/common/news", {
    method: "GET",
  });
}

export async function getSportsList(): Promise<Sports[]> {
  return await apiFetch<Sports[]>("/api/common/sports", {
    method: "GET",
  });
}

export async function getStates(): Promise<States[]> {
  return await apiFetch<States[]>("/api/common/states", {
    method: "GET",
  });
}
...
export async function getSchools(
  state: string,
  instType: string
): Promise<SchoolsByState[]> {
  return await apiFetch<SchoolsByState[]>(
    `/api/common/schools?state=${state}&institutionType=${instType}`,
    {
      method: "GET",
    }
  );
...
export async function getAds(type: string): Promise<Ads[]> {
  return await apiFetch<Ads[]>(`/api/common/ads?type=${type}`, {
    method: "GET",
  });
}
